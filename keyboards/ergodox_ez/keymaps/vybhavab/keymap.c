...
[BASE_PD] = LAYOUT_ergodox_pretty(
  ...
  KC_TAB,          KC_SCLN,     KC_COMM,       KC_DOT,  KC_P,    KC_Y,    KC_NO,                G(S(C(KC_F24))),    KC_F,        KC_G,       KC_C,       KC_R,    KC_L,    KC_BSLS,
  ...
  KC_HYPR,         KC_DLR,      OSL(LSWITCH),  KC_LEFT, KC_RGHT,                                                                        KC_UP,       KC_DOWN,    KC_SLSH,    KC_AT,   KC_MEH,
                                                         ...
                                                         KC_BSPC,GUI_T(KC_TAB),KC_LCTL,         KC_LALT,            KC_ENT, KC_SPC
),
...
[QWERTY] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS,        KC_DEL,      KC_TRNS,      KC_TRNS,KC_TRNS,                                                                    KC_TRNS,   KC_TRNS,   KC_KB_MUTE,G(S(C(KC_F24))), KC_TRNS,
